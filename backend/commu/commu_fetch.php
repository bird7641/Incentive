...
if ($textsearch != "" && $textsearchMonth != "" && $textsearchYear != "") {
    $stmt = $stmt . "WHERE (tbstaff.staffID LIKE '%" . $textsearch . "%' OR tbstaff.staffNameTH LIKE '%" . $textsearch . "%' ) AND MONTH(tbcommu.commuDate) = '" . $textsearchMonth . "' AND YEAR(tbcommu.commuDate) = '" . $textsearchYear . "' ";
} elseif ($textsearch != "" && $textsearchMonth != "") {
    $stmt = $stmt . "WHERE (tbstaff.staffID LIKE '%" . $textsearch . "%' OR tbstaff.staffNameTH LIKE '%" . $textsearch . "%' ) AND MONTH(tbcommu.commuDate) = '" . $textsearchMonth . "'  ";
} elseif ($textsearch != ""  && $textsearchYear != "") {
    $stmt = $stmt . "WHERE (tbstaff.staffID LIKE '%" . $textsearch . "%' OR tbstaff.staffNameTH LIKE '%" . $textsearch . "%' ) AND YEAR(tbcommu.commuDate) = '" . $textsearchYear . "'  ";
} elseif ($textsearchMonth != "" && $textsearchYear != "") {
    $stmt = $stmt . "WHERE  MONTH(tbcommu.commuDate) = '" . $textsearchMonth . "' AND YEAR(tbcommu.commuDate) = '" . $textsearchYear . "'  ";
} elseif ($textsearch != "") {
    $stmt = $stmt . "WHERE  (tbstaff.staffID LIKE '%" . $textsearch . "%' OR tbstaff.staffNameTH LIKE '%" . $textsearch . "%' )  ";
} elseif ($textsearchMonth != "") {
    $stmt = $stmt . "WHERE MONTH(tbcommu.commuDate) = '" . $textsearchMonth . "' ";
} elseif ($textsearchYear != "") {
    $stmt = $stmt . "WHERE YEAR(tbcommu.commuDate) = '" . $textsearchYear . "' ";
}
